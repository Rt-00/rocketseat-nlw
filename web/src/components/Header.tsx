  ...
  return (
    <div className="w-full max-w-3xl mx-auto flex items-center justify-between">
      ...
      <Dialog.Root>
        ...
        item-center
        gap-3
        hover:border-violet-300 transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-violet-600 focus:ring-offset-2 focus:ring-offset-background"
        >
